        ...
        <div className="appHeader__bottom">
          ...
          <div className="appHeader__bottom-contacts">
            ...
            <div className="appHeader__bottom-item">
              <div className="appHeader__bottom-icon">
                <img src={phone} alt="phone" />
              </div>
              <a href="tel:+79509999999" target="_blank" rel="noreferrer">
                +7 (950) 999-99-99
              </a>
            </div>
            <div className="appHeader__bottom-item">
              ...
              <address>Североуральск, пер Школьный, 1</address>
            </div>
            <div className="appHeader__bottom-item">
              <div className="appHeader__bottom-icon">
          ...
          <button
            onClick={() => dispatch(changePopupBasketActivation(true))}
            className="button button__basket appHeader__bottom-basket"
          >
